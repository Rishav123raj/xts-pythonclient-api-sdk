...
def on_message1502_json_full(data):
    print('I received a 1502 Market depth message!' + str(data))

# Callback for message code 1505 FULL
def on_message1505_json_full(data):
    print('I received a 1505 Candle data message!' + str(data))
...
def on_message1510_json_full(data):
    print('I received a 1510 Open interest message!' + str(data))

# Callback for message code 1512 FULL
def on_message1512_json_full(data):
    print('I received a 1512 Level1,LTP message!' + str(data))

# Callback for message code 1105 FULL
def on_message1105_json_full(data):
    print('I received a 1105, Instrument Property Change Event message!' + str(data))
  # Callback for message code 1105 FULL
...
def on_message1501_json_partial(data):
    print('I received a 1501, Touchline Event message!' + str(data))
...
def on_message1512_json_partial(data):
    print('I received a 1512, LTP Event message!' + str(data))
